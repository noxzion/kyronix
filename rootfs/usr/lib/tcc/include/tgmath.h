...
#ifndef __cplusplus
#define __tgmath_real(x, F) _Generic((x), float: F##f, long double: F##l, default: F)(x)
#define __tgmath_real_2_1(x, y, F) _Generic((x), float: F##f, long double: F##l, default: F)(x, y)
