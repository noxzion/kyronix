...
#define atomic_store(object, desired) atomic_store_explicit(object, desired, __ATOMIC_SEQ_CST)
...
#define atomic_exchange(object, desired) atomic_exchange_explicit(object, desired, __ATOMIC_SEQ_CST)
#define __atomic_compare_exchange_n(ptr, expected, desired, weak, success, failure)                \
    ({                                                                                             \
        typeof(*(ptr)) __desired = (desired);                                                      \
        __atomic_compare_exchange((ptr), (expected), &__desired, (weak), (success), (failure));    \
    })
...
#define atomic_compare_exchange_strong(object, expected, desired)                                  \
    atomic_compare_exchange_strong_explicit(object, expected, desired, __ATOMIC_SEQ_CST,           \
                                            __ATOMIC_SEQ_CST)
...
#define atomic_compare_exchange_weak(object, expected, desired)                                    \
    atomic_compare_exchange_weak_explicit(object, expected, desired, __ATOMIC_SEQ_CST,             \
                                          __ATOMIC_SEQ_CST)
