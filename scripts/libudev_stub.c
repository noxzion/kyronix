...
E void *udev_new(void) { return NULL; }
E void udev_unref(void *u) { (void) u; }
...
E void udev_monitor_unref(void *m) { (void) m; }
...
E void udev_enumerate_unref(void *e) { (void) e; }
...
E void udev_device_unref(void *d) { (void) d; }
